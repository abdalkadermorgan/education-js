...
const Header = (props) => {
    ...
    return (
        ...
        <header className="relative bg-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6">
                <div className="flex justify-between items-center border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
                    ...
                    <div className="hover-dropdown hidden md:flex items-center justify-end relative">
                        <button onClick={props.onShowCart} className="whitespace-nowrap text-base font-medium text-gray-500 hover:text-gray-900 ">
            ...
            <div className="absolute top-0 inset-x-0 p-2 transition transform origin-top-right md:hidden opacity-0 scale-95">
